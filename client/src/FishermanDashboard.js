...
export default function FishermanDashboard({ onLogout, user, catches, setCatches, username }) {
  ...
  return (
    <Box sx={{ bgcolor: '#e3f2fd', minHeight: '100vh' }}>
      ...
      <Box sx={{ p: 2, display: 'flex', justifyContent: 'center' }}>
        <Typography variant="h5" sx={{ fontWeight: 600, color: '#01579b', textAlign: 'center' }}>
